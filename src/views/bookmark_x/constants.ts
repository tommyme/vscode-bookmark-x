...
export const ICON_SORTING_BOOKMARK = new ThemeIcon(
  "bookmark",
  new ThemeColor("bmx.bookmark.sortingItemColor"),
);
export const ICON_SORTING_ACTIVE_GROUP = new ThemeIcon(
  "folder-opened",
  new ThemeColor("bmx.bookmark.sortingItemColor"),
);
export const ICON_SORTING_GROUP = new ThemeIcon(
  "folder",
  new ThemeColor("bmx.bookmark.sortingItemColor"),
);
